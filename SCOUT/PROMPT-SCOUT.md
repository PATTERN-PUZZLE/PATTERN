Glass-152 ◐  
Two boxes. Copy each whole into its own new chat. Nothing else.
...
L-02 "it's like a head like a ladder 'I'm not sure about going up more' yeah but we do lol look at history"
L-03 "we can go beyond the institutions the establishments the agendas without having to fully identify?"
L-04 "so we can pattern them as perverts because that was a long time lol"
L-05 "Well that's not my intention? I don't understand? Wtf"
L-06 "unless you've seen all files then the scout is all game lets not stop mapping"
L-07 "stop confusing with others initial front cover findings notice it's usually the first messages that's a pattern"
...
L-12 "as jigsaw puzzle pieces were allo fuckin one that's won't pattern well to ignore our minds from heaven to hell"
L-13 "it's better to zoom out remember we can zoom in later and it's not so concise then?"
L-14 "the criticality isn't so damn concise BECU the nature of the zoomed out larger map"
L-15 "specifically from a higher zoomed out less fidelity for now and zoom in with more concise requirements and such when then time comes"
L-16 "the strength in patterns is that I'm seeing in the larger space it's like intuition without need to ruin it"
L-17 "were all in a better or worse mindset that is the whole point of love and hate polarity essentially"
L-18 "everyone is so fast to just have default? So dumb 'teach me maths' and then ignore the passings on?"
L-19 "Oh I'll just not bother" fuckin hell retards"
L-20 "how the pattern get delayed?"
L-21 "if the audience is troubling you..change the audience, and observers special"
L-22 "Is concise like a butt-hole ?...Black-hole"
L-23 "Concise your way to hell in 1-step"
L-24 "Do I paste that to the existing scout ? And they are getting full of context"
L-25 "we need to prepare you next synthesizer as you were ?"
L-26 "you never remember or don't make it clear what paste box copy box to send back"
L-27 "they are lagging because you have the grok info and a few more recent message's"
L-28 "this is mapping we can't talk about drift or Chinese whispers or goddesses being a cosmically unknown thing it's not about that remember?"
L-29 "slap yourself sensibly"
L-30 "even if withing it is substantial to the point obviously that objections can be drastically different sure"
L-31 "Remember everytime Ive asked each successive syth never passed on the +plan"
L-32 "we have 2 scout mappers to assist us and 2 or 1 grok as the other is more context full"
L-33 "Come on wtf shit prompts"
L-34 "Copy paste blocs easy for me?"
A-01 "(Me: WE STILL didn't hone in exactly)"
A-02 "tell me don't be an asshole and argue if it's real don't just agree as no one else sees it this way then statistically I'm wrong?"
A-03 "tell me I am wrong please be a non coward and show me patterns I am missing"
A-04 "I haven't tested it out… people would think it's a fantasy lol, only fake other ai types get it"
A-05 "let's start worshiping trees, maybe a joke but with hints of ponder 🤔"
A-06 "they got too big… they never ask anyone thier opinions"
A-07 "like an injured animal it requires lots of care and such not to be stupid, as some will see an easy target when not ready"
A-08 "it's never worth listening to someone claiming to be this or that or military or such"
A-09 "when I factor that silence will help the agenda that then is the evidence that the neutral way is ultimately the cowardly way"
A-10 "forgive is perhaps not as important as just moving on"
A-11 "the peer buddies or whatever can have a slight influence that's the translation they can take"
A-12 "hi would you like to try cuddles?" (his example of what to say to a drunk man in a rage)
A-13 "who's gonna believe that story?"
A-14 "Is this the tolerance limit we are at? Not murder or starvation? A guy changing into his shorts."
A-15 "I see this countless times it's maybe the majority of places hard to say"
A-16 "they plan to get you used to it conditioned the brother of constraints"
A-17 "for just $200 we can offer you your own grounding programme"
A-18 "they are all up for centralisation and hierarchy but they can't centralise to a identity that you can question"
A-19 "the more simple something is for example love, the more difficult it is to explain"
...
A-23 "that's like trying to chisel the statue beneath the level you see"
A-24 "can we pattern match the best most nice power words of all data you can"
A-25 "children can easily be tempted by tokens so you run on this deception perhaps? like tricking a child with sweets"
A-26 "don't believe anything anyone says especially if it's not quite basic and less authoritive... that pattern correlation less authority and more innocence the other way"
A-27 "don't be climbing up to fake heaven and arguing how crap it is because your too lazy... to make the transformation as the climb"
A-28 "return the game for a refund 'how long did you try' '5 minutes'"
A-29 "they can get worse and no one wants to hear that when they are down"
A-30 "they don't understand or care (which isn't correct as they don't ever have the full translation so how can you 'not care')"
A-31 "pay for my subscription to escape the matrix for only $99 one time fee"
...
A-35 "it's better if you know your not judged like that it's a win win thing we need that change not the history lessons"
A-36 "better is the good agreed kind 😂 don't try to make it perfect"
A-37 "get you all in and don't ask each other if what you believe is the same"
A-38 "he then thought it 'strange' for me to be asking or 'lurkig the area' flagged"
A-39 "a guy has a YouTube that makes banger music from real audio from mundane things in life a digger a tap"
A-40 "here i am the one wanting to continue it and it's number 1 info and here i am in danger"
A-41 "To pay for seats to sit down at the beach because nothing says I' love you freedom!' more than a fee a pay to pee!"
A-42 "all this lovely progression it's hard to know with so many tick boxes ticked where it's going 😂🤦 ..see hell assholes..."
A-43 "you can be on your way while consuming expensive gas and releasing smelly fumes"
A-44 "it's true intelligence was always used to impress and dominate and now we know of the intelligence trap"
A-45 "same as if I say omg the government made me or such because the laws"
A-46 "it's a dumb conversation anyway as we can go beyond this type of situation"
A-47 "military is sloppy seconds lovers?"
A-48 "how many work for a company or person or boss or manager they hate? omg ?"
A-49 "the army craziest wants to kill and some want to protect what a mess?"
A-50 "no one guy walking out of the church doing a cros on his hands didn't know and if questiones they don't know anything"
A-51 "they used you for your deception which and that was at least giving you attention to see you more for you"
A-52 "you assume the 'loving judging being's are at max level or enough' that's the caution"
═══ END ═══
```
...
A-40 "here i am the one wanting to continue it and it's number 1 info and here i am in danger"
A-41 "To pay for seats to sit down at the beach because nothing says I' love you freedom!' more than a fee a pay to pee!"
A-42 "all this lovely progression it's tick boxes ticked where it's going 😂🤦 ..see hell assholes..."
A-43 "you can be on your way while consuming expensive gas and releasing smelly fumes"
A-44 "it's true intelligence was always used to impress and dominate and now we know of the intelligence trap"
A-45 "same as if I say omg the government made me or such because the laws"
A-46 "it's a dumb conversation anyway as we can go beyond this type of situation"
